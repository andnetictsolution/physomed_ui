...
console.log('Outside mounted', props.patientId)

onMounted(() => {
  const idd = props.patientId
  console.log('Patient Id', idd)
  setTimeout(async () => {
...
const medicalAssesment = computed(() => {
  return viewvitalsign.value.data?.patient?.medicalHistory[0]?.list_of_other_diagnosis
})
...
<template>
  <Accordion :activeIndex="0">
    ...
    <AccordionTab header="Assement" title="Assement" class="text-xl">
      ...
      <p class="m-0">List of other Diagonsis</p>
