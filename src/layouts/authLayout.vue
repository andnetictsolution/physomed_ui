  ...
  >
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <a
            href="/nurse/patientMedicalHistory"
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
          >
            <svg
              class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Patients Medical History</span>
          </a>
        </li>
        <li>
          <a
            href="/doctor/investigation"
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
          >
            <svg
              class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Doctor Investigations</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">View User</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">View Patient</span>
          </a>
        </li>
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Add Service</span>
          </a>
        </li>
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">View Service</span>
          </a>
        </li>
      </ul>
